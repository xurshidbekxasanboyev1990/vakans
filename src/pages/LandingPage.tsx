    ...
    <div className="relative min-h-screen bg-white dark:bg-secondary-950 overflow-hidden">
      ...
      <section className="py-24 bg-secondary-50 dark:bg-secondary-900/50">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { number: "10,000+", label: "Faol ish e'lonlari", icon: Briefcase },
              { number: "50,000+", label: "Foydalanuvchilar", icon: Users },
              { number: "1,000+", label: "Kompaniyalar", icon: Building2 },
              { number: "95%", label: "Mamnunlik darajasi", icon: Star },
            ].map((stat, i) => (
              <motion.div 
                key={i}
                variants={scaleIn}
          ...
          >
            {[
              ...
              >
                {/* Step Number */}
                <motion.div 
                  className="relative z-10 flex-shrink-0 w-20 h-20 rounded-3xl bg-gradient-to-br from-primary-600 to-purple-600 flex items-center justify-center text-white text-3xl font-bold shadow-xl"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                >
                  {item.step}
                </motion.div>
                ...
                {/* Connector Line */}
                {i < 2 && (
                  <div className="absolute left-10 top-20 w-0.5 h-12 bg-gradient-to-b from-primary-500 to-primary-300" />
                )}
      ...
      <section className="py-32 bg-white dark:bg-secondary-950">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { title: "Frontend Developer", company: "Tech Solutions", salary: "8-12M", location: "Toshkent", type: "To'liq vaqt" },
              { title: "Sotuvchi", company: "Market Plus", salary: "3-5M", location: "Samarqand", type: "Yarim stavka" },
              { title: "Haydovchi", company: "Logistic Pro", salary: "4-6M", location: "Buxoro", type: "To'liq vaqt" },
            ].map((job, i) => (
              <motion.div
                key={i}
                variants={itemVariants}
